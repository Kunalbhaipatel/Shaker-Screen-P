...
if uploaded_file:
    ...
    st.line_chart(df[["Shaker #1", "Shaker #2", "Shaker #3", "SLI"]].dropna())
    ...
    st.caption("This dashboard is a prototype. Extend it with live training on labeled screen replacement logs.")
else:
